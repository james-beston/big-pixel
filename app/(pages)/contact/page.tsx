import GetIcon from '@/app/components/icon';
        ...
        <div className='col-span-2 md:col-span-1'>
          <div className='flex flex-col space-y-6'>
            ...
            <div className='flex space-x-6 items-center'>
              <GetIcon icon='envelope' size={24} weight='regular' />
            ...
            {/* Phone */}
            <div className='flex space-x-6 items-center'>
              <GetIcon icon='phone' size={24} weight='regular' />
          ...
          <div className='mt-12 flex flex-col space-y-6'>      
            ...
            {/* LinkedIn */}
            <div className='flex space-x-6 items-center'>
              <GetIcon icon='linkedin-in' size={24} weight='brands' />
            ...
            {/* Instagram */}
            <div className='flex space-x-6 items-center'>
              <GetIcon icon='instagram' size={24} weight='brands' />
            ...
            {/* Facebook */}
            <div className='flex space-x-6 items-center'>
              <GetIcon icon='facebook' size={24} weight='brands' />
            ...
            {/* Threads */}
            <div className='flex space-x-6 items-center'>
              <GetIcon icon='threads' size={24} weight='brands' />
